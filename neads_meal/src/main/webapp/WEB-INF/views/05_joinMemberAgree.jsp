            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        ...
                        <form class="needs-validation" name="agreeForm" action="#" method="post" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <label class="check" for="allAgree"> <em>니즈밀의 모든 약관을 확인하고 전체 동의합니다.</em></label>
                                </div>
                                
                                <div class="col-12 mb-1">
                                    <input type="checkbox" name="agree" id="agree1" value="check">
                                    <label class="check_s" for="termsAgree"><strong>(필수)</strong> 이용약관</label>
                                    
                                </div>
                                <div class="col-12 mb-3">
                                    <textarea style="width: 100%; height: 120px; resize: none;" readonly>제1조(목적)

                                        표준약관 제10023호
                                        
                                        이 약관은 주식회사 제일씨엔에프 회사(전자거래 사업자)가 운영하는 담짜몰 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
                                        ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」
                                        
                                        
                                        제2조(정의)
                                        
                                        ① "몰"이란 주식회사 제일씨엔에프 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                                        ...
                                        1. 이 약관은 년 월 일부터 적용됩니다.</textarea>
                            ...
                            <div class="row">
                                <div class="col-12 mb-1">
                                    ...
                                    <input type="checkbox" name="agree" id="agree2" value="check">
                                    <label class="check_s" for="termsAgree2"><strong>(필수)</strong> 개인정보 수집 및 이용 </label>
                                </div>
                                <div class="col-12 mb-5">

                                    <textarea style="width: 100%; height: 120px; resize: none;" readonly>회사는 회원가입, 민원 등 고객상담 처리, 본인확인(14세 미만 아동 확인) 등 의사소통을 위한 정보 활용 및 이벤트 등과 같은 마케팅용도 활용, 회원의 서비스 이용에 대한 통계, 이용자들의 개인정보를 통한 서비스 개발을 위해 아래와 같은 개인정보를 수집하고 있습니다.
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <button class="btn hvr-hover" type="button" style="width: 115px; color:white; font-size: small;" onclick = "location.href = '#'">이전 단계</button>
    
                            </div>
                            <div class="col-md-3 mb-3">
                                <button class="btn hvr-hover" type="button" id="agreeSubmitBtn" style="width: 115px; color:white; font-size: small; background-color:rgba(23, 45, 15, 0.848);" >다음 단계</button>
